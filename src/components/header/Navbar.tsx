...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-surface-bg border-b border-border-main">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center">
          <div className="flex items-center gap-2 bg-surface-white text-text-muted px-3.5 py-2 rounded-md text-body-sm w-[340px] cursor-pointer hover:bg-border-main transition-colors border border-transparent hover:border-border-main">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
            ...
            <span className="truncate">Search by developers, locations and projects</span>
          </div>
        </div>

        <div className="hidden xl:flex items-center gap-6">
          <nav className="flex items-center gap-6 text-btn text-text-main">
          ...
          <button
            type="button"
            className="bg-primary hover:bg-primary-hover text-white text-btn px-4 py-2 rounded-md transition-colors cursor-pointer shadow-card"
          >
            Get Started
          </button>
        </div>
      ...
      {mobileMenuOpen && (
        <div className="xl:hidden bg-surface-bg border-b border-border-main px-4 py-4 space-y-3">
          <div className="flex flex-col gap-2.5 text-btn text-text-main">
            <Link href="/" className="py-2 border-b border-border-main">Properties</Link>
            <Link href="/" className="py-2 border-b border-border-main">Services</Link>
            <Link href="/" className="py-2 border-b border-border-main">Resources</Link>
            <Link href="/" className="py-2 border-b border-border-main">Company</Link>
            <Link href="/verify" className="py-2 border-b border-border-main">Sign In</Link>
          </div>
          <button
            type="button"
            className="w-full bg-primary hover:bg-primary-hover text-white py-2.5 rounded-md text-btn transition-colors"
          >
            Get Started
          </button>
        </div>
